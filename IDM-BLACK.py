...
class DownloadManager:
    def __init__(self, root):
        ...
        self.version_label.place(x=420, y=280)
    ...
    def download_file(self):
        ...
        file_name = os.path.join(path, original_file_name)

        # Lógica para renombrar si el archivo ya existe
    ...
    def update_progress(self, speed):
        ...
        remaining_time = (remaining_size / 1024) / speed if speed > 0 else 0
